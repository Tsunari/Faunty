...
mixin _$PlaceModel {
  ...
  bool get registrationMode => throw _privateConstructorUsedError;
...
class _$PlaceModelImpl extends _PlaceModel {
  ...
  @override
  String toString() {
    return 'PlaceModel(id: $id, name: $name, displayName: $displayName, description: $description, imageUrl: $imageUrl, mapsUrl: $mapsUrl, registrationMode: $registrationMode)';
  }
